...
public:
   ...
   */
  TcpMine (const TcpMine& sock);
  virtual ~TcpMine (void);
...
protected:
  ...
  virtual Ptr<TcpSocketBase> Fork (void); // Call CopyObject<TcpMine> to clone me
