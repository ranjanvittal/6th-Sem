/* Generated By:JavaCC: Do not edit this line. LoopyTacoJavaParser.java */
import syntaxtree.*;
import java.util.Vector;


public class LoopyTacoJavaParser implements LoopyTacoJavaParserConstants {
  ...
  static final public ForStatement ForStatement() throws ParseException {
   ...
   Statement n21;
    ...
    n14 = jj_consume_token(SEMICOLON);
             n13 = JTBToolkit.makeNodeToken(n14);
    n15 = Identifier();
    n17 = jj_consume_token(ASSIGN);
             n16 = JTBToolkit.makeNodeToken(n17);
    n18 = Expression();
    n20 = jj_consume_token(RPAREN);
             n19 = JTBToolkit.makeNodeToken(n20);
    n21 = Statement();
     {if (true) return new ForStatement(n0,n2,n4,n6,n7,n9,n10,n12,n13,n15,n16,n18,n19,n21);}
    throw new Error("Missing return statement in function");
  }

  static final public LoopAnnotation LoopAnnotation() throws ParseException {
   NodeChoice n0;
   LoopTileAnn n1;
   LoopInvariantCodeMotionAnn n2;
   LoopUnrollAnn n3;
   LoopDistributionAnn n4;
    if (jj_2_8(2147483647)) {
      n1 = LoopTileAnn();
        n0 = new NodeChoice(n1, 0);
    } else if (jj_2_9(2147483647)) {
      n2 = LoopInvariantCodeMotionAnn();
        n0 = new NodeChoice(n2, 1);
    } else if (jj_2_10(2147483647)) {
      n3 = LoopUnrollAnn();
        n0 = new NodeChoice(n3, 2);
    } else if (jj_2_11(2147483647)) {
      n4 = LoopDistributionAnn();
        n0 = new NodeChoice(n4, 3);
    } else {
      jj_consume_token(-1);
      throw new ParseException();
    }
     {if (true) return new LoopAnnotation(n0);}
    throw new Error("Missing return statement in function");
  }

  static final public LoopTileAnn LoopTileAnn() throws ParseException {
   NodeToken n0;
   Token n1;
   NodeToken n2;
   Token n3;
   ...
   Token n7;
    n1 = jj_consume_token(SCOMMENT1);
                    n0 = JTBToolkit.makeNodeToken(n1);
    n3 = jj_consume_token(LOOPTILE);
                   n2 = JTBToolkit.makeNodeToken(n3);
    n4 = IntegerLiteral();
    n5 = IntegerLiteral();
    n7 = jj_consume_token(SCOMMENT2);
                    n6 = JTBToolkit.makeNodeToken(n7);
     {if (true) return new LoopTileAnn(n0,n2,n4,n5,n6);}
    throw new Error("Missing return statement in function");
  }

  static final public LoopInvariantCodeMotionAnn LoopInvariantCodeMotionAnn() throws ParseException {
   NodeToken n0;
   Token n1;
   NodeToken n2;
   Token n3;
   ...
   Token n5;
    n1 = jj_consume_token(SCOMMENT1);
                    n0 = JTBToolkit.makeNodeToken(n1);
    n3 = jj_consume_token(LICM);
               n2 = JTBToolkit.makeNodeToken(n3);
    n5 = jj_consume_token(SCOMMENT2);
                    n4 = JTBToolkit.makeNodeToken(n5);
     {if (true) return new LoopInvariantCodeMotionAnn(n0,n2,n4);}
    throw new Error("Missing return statement in function");
  }

  static final public LoopUnrollAnn LoopUnrollAnn() throws ParseException {
   NodeToken n0;
   Token n1;
   NodeToken n2;
   Token n3;
   ...
   Token n6;
    n1 = jj_consume_token(SCOMMENT1);
                    n0 = JTBToolkit.makeNodeToken(n1);
    n3 = jj_consume_token(LOOPUNROLL);
                     n2 = JTBToolkit.makeNodeToken(n3);
    n4 = IntegerLiteral();
    n6 = jj_consume_token(SCOMMENT2);
                    n5 = JTBToolkit.makeNodeToken(n6);
     {if (true) return new LoopUnrollAnn(n0,n2,n4,n5);}
    throw new Error("Missing return statement in function");
  }

  static final public LoopDistributionAnn LoopDistributionAnn() throws ParseException {
   NodeToken n0;
   Token n1;
   NodeToken n2;
   Token n3;
   ...
   Token n5;
    n1 = jj_consume_token(SCOMMENT1);
                    n0 = JTBToolkit.makeNodeToken(n1);
    n3 = jj_consume_token(LOOPDISTRIBUTE);
                         n2 = JTBToolkit.makeNodeToken(n3);
    n5 = jj_consume_token(SCOMMENT2);
                    n4 = JTBToolkit.makeNodeToken(n5);
     {if (true) return new LoopDistributionAnn(n0,n2,n4);}
    throw new Error("Missing return statement in function");
  }
  ...
  static final public ConstOrId ConstOrId() throws ParseException {
   NodeChoice n0;
   Identifier n1;
   IntegerLiteral n2;
   TrueLiteral n3;
   FalseLiteral n4;
    ...
    default:
     ...
     {if (true) return new ConstOrId(n0);}
    throw new Error("Missing return statement in function");
  }
  ...
  static private boolean jj_3R_22() {
    ...
    if (jj_scan_token(LOOPDISTRIBUTE)) return true;
  ...
  static private boolean jj_3R_21() {
    if (jj_scan_token(SCOMMENT1)) return true;
    if (jj_scan_token(LOOPUNROLL)) return true;
    if (jj_3R_28()) return true;
    if (jj_scan_token(SCOMMENT2)) return true;
    return false;
  }
  ...
  static private boolean jj_3R_20() {
    if (jj_scan_token(SCOMMENT1)) return true;
    if (jj_scan_token(LICM)) return true;
    if (jj_scan_token(SCOMMENT2)) return true;
    return false;
  }
  ...
  static private boolean jj_3R_19() {
    if (jj_scan_token(SCOMMENT1)) return true;
    if (jj_scan_token(LOOPTILE)) return true;
    if (jj_3R_28()) return true;
    if (jj_3R_28()) return true;
    if (jj_scan_token(SCOMMENT2)) return true;
    return false;
  ...
  static public LoopyTacoJavaParserTokenManager token_source;
  ...
  static {
   ...
   private static void jj_la1_init_0() {
      jj_la1_0 = new int[] {0x800000,0x70001000,0x800000,0x80400000,0x0,0x80400000,0x0,0x80400000,0x70001000,0x0,0x80400000,0x1000,0x70000000,0x70001000,0x0,0x8200000,0x0,0x0,0x8000000,0x200000,0x8000000,};
   }
   private static void jj_la1_init_1() {
      jj_la1_1 = new int[] {0x0,0x40a00,0x0,0x40000,0x8,0x40000,0x8,0x40000,0x40a00,0x200000,0x40000,0x0,0xa00,0x40a00,0x800,0x60184,0x40000,0x200000,0x60180,0x4,0x60100,};
   }
  ...
  public LoopyTacoJavaParser(java.io.InputStream stream) {
     this(stream, null);
  }
  /** Constructor with InputStream and supplied encoding */
  public LoopyTacoJavaParser(java.io.InputStream stream, String encoding) {
    ...
    token_source = new LoopyTacoJavaParserTokenManager(jj_input_stream);
    token = new Token();
    jj_ntk = -1;
    jj_gen = 0;
  ...
  /** Constructor. */
  public LoopyTacoJavaParser(java.io.Reader stream) {
    if (jj_initialized_once) {
      System.out.println("ERROR: Second call to constructor of static parser. ");
      System.out.println("       You must either use ReInit() or set the JavaCC option STATIC to false");
      System.out.println("       during parser generation.");
  ...
  public LoopyTacoJavaParser(LoopyTacoJavaParserTokenManager tm) {
    if (jj_initialized_once) {
      System.out.println("ERROR: Second call to constructor of static parser. ");
      System.out.println("       You must either use ReInit() or set the JavaCC option STATIC to false");
      System.out.println("       during parser generation.");
  ...
  /** Reinitialise. */
  public void ReInit(LoopyTacoJavaParserTokenManager tm) {
    token_source = tm;
    token = new Token();
    jj_ntk = -1;
    jj_gen = 0;
