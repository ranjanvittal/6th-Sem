...
public class GJDepth2<R,A> extends GJDepthFirst<R,A> {
    ...
    Hashtable<String, Hashtable<String, String>> globalRenamedVariables = new Hashtable<String, Hashtable<String, String>>();



    public void makeClassVariables() {

        Enumeration<String> en = classVariables.keys();
        ...
        while(en.hasMoreElements()) {
            ...
            globalRenamedVariables.put(klass, new Hashtable<String, String>());

            Hashtable<String, String> renamedVariables = globalRenamedVariables.get(klass);
            ...
            while(en3.hasMoreElements()) {
                name = en3.nextElement();
                renamedVariables.put(name, parentKlass + "_" + name);
            }
    ...
    public void print() {
        ...
        while(en.hasMoreElements()) {
            ...
            Hashtable<String, String> s = globalRenamedVariables.get(name);
    ...
    public R visit(Goal n, A argu) {
        ...
        makeClassVariables();
        //print();
        return (R) globalRenamedVariables;
    }
